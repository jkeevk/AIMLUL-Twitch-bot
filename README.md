...
| `!очко`    | Бесплатный запуск игры при наличии билетов*                | Все пользователи               |
| `!voteban` | Голосование за тайм-аут пользователя                       | Все пользователи               |
...
*За победу в испытании пивом вы получаете игровые билеты. На них можно участвовать в карточной игре «Очко» со всеми желающими
...
- **Redis** - асинхронное кэширование и хранение временных данных
