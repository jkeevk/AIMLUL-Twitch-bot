...
|---------|-----------------------------------------------------------------|--------|
| `!очко` | Игра в 21 очко с автоматическим таймаутом для проигравшего      | Все пользователи |
...
| `!тестовая_бочка` | Тестовая массовая блокировка до 10 пользователей (в разработке) | Администраторы |
